...
class InSe(PTMC):
	...
	M_Ep = -7.71158434-vbo
	X_Ep = -13.4291514 -vbo
	M_Ese = -3.41635987-vbo
	X_Ese = -8.40148895-vbo
	...
	bondpar_1=np.array([-0.89720693,2.18519326,1.95850091,-0.59318061,-0.13151376,-0.15835632,0.07073994])
	bondpar_2=np.array([-2.01705889,2.89536548,3.36520783,0.76531940,-0.05317980,-0.04058911,3.13426005])
	bondpar_3=np.array([-0.20991596,0.03474167,0.64606742,0.24037372,0.05715835,0.05384217,-0.17916946])
	bondpar_4=np.array([-0.13595759,0.77021899,0.47352723,0.00555993, 0.63440153 ,0.69224008,0.00634460])
	bondpar_5=np.array([-0.03494643,-0.54053258,0.65805399 ,-0.14298284,0.24845302,-0.33628734,0.01202671])
...
class GaSe(PTMC):
	...
	#bond sp3s* parameters
	bondpar_1=np.array([-0.99982289,2.47300407,2.19460065,-0.66846530, -0.26009170,-0.17469454,-0.01155160])
	bondpar_2=np.array([-2.12091242,3.22487967,3.37575056,-0.03907311,-0.31393568,0.16357703,4.27952735])
	bondpar_3=np.array([-0.18819954,-0.09269253,0.61466318,0.28153565,0.13387801,0.06623738,-0.24447866])
	bondpar_4=np.array([-0.13717700,-0.53063824, 0.46838761,0.01974197,0.70818455 ,0.55464543,-0.04180928])
	bondpar_5=np.array([0.08050336,-0.60159661,  0.68071300 ,-0.19323165,0.20768969,-0.26398961,0.05957698])
...
mat = Stack([GaSe(),GaSe(),GaSe()],0.382,strained=True)
lattice = mat.lat
...
ldos_map = solver.calc_spatial_ldos(energy=-11.56, broadening=0.05)  # [eV]
ldos_map.plot(axes="yz")

plt.subplot(133, title="Cond.")
ldos_map = solver.calc_spatial_ldos(energy=-9.91, broadening=0.05)  # [eV]
ldos_map.plot(axes="yz")
