...
dos = kpm.calc_dos(energy=np.linspace(-30, -10.59, 2000), broadening=0.2, num_random=16)
#dos.plot()
#plt.show()

for sub_name in ["X4", "X1b"]:
	ldos = kpm.calc_ldos(energy=np.linspace(-30, -10.26, 2000), broadening=0.2,
