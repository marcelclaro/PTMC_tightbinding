...
mat = Stack([GaSe(),GaSe(),GaSe(),GaSe(),GaSe(),GaSe(),InSe(),InSe(),InSe(),InSe(),InSe(),InSe()],0.388,strained=True)
lattice = mat.lat
...
ldos_map = solver.calc_spatial_ldos(energy=-9.99, broadening=0.05)  # [eV]
ldos_map.plot(axes="yz")
